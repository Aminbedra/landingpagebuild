...
// 'users' is account-scoped, not market-scoped — see AdminLayout, which
// renders that nav item itself rather than inside this component.
export type AdminView = 'copy' | 'leads' | 'users'
