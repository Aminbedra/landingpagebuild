// Static style presets (Phase 8) — mirrors worker/src/lib/presets.ts and
// astro/src/lib/presets.ts. Duplicated, not imported: admin/ is a
// separate npm project with no shared package, the same reason
// MarketConfig already has independent copies across this codebase. Keep
// all three in sync by hand if these ever change.
